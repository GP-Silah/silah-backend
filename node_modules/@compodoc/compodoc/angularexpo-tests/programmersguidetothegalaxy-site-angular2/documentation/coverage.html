...
<table class="table table-bordered coverage" id="coverage-table">
    ...
    <tbody>
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./components/AppComponent.html">app/app.component.ts</a>
            </td>
            <td>component</td>
            <td>AppComponent</td>
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./components/CodeComponent.html">app/code.component.ts</a>
            </td>
            <td>component</td>
            <td>CodeComponent</td>
            <td align="right" data-sort="0">
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./injectables/CodeService.html">app/code.service.ts</a>
            </td>
            <td>injectable</td>
            <td>CodeService</td>
            <td align="right" data-sort="0">
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./interfaces/FolderMenuItem.html">app/code.service.ts</a>
            </td>
            <td>interface</td>
            <td>FolderMenuItem</td>
            <td align="right" data-sort="0">
                <span class="coverage-percent">0 %</span>
                <span class="coverage-count">(0/3)</span>
            </td>
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./interfaces/LanguageMenuItem.html">app/code.service.ts</a>
            </td>
            <td>interface</td>
            <td>LanguageMenuItem</td>
            <td align="right" data-sort="0">
                <span class="coverage-percent">0 %</span>
                <span class="coverage-count">(0/3)</span>
            </td>
