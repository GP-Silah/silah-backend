...
<table class="table table-bordered coverage" id="coverage-table">
    ...
    <tbody>
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./miscellaneous/variables.html#API_ROOT">test/fixtures/library/libs/my-lib/core/src/core.module.ts</a>
            </td>
            <td>variable</td>
            <td>API_ROOT</td>
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./miscellaneous/functions.html#getDefaultApiRoot">test/fixtures/library/libs/my-lib/core/src/utils.ts</a>
            </td>
            <td>function</td>
            <td>getDefaultApiRoot</td>
            <td align="right" data-sort="0">
                <span class="coverage-percent">0 %</span>
                <span class="coverage-count">(0/1)</span>
            </td>
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./interfaces/DataConfig.html">test/fixtures/library/libs/my-lib/data/src/data.module.ts</a>
            </td>
            <td>interface</td>
            <td>DataConfig</td>
            <td align="right" data-sort="0">
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./miscellaneous/variables.html#DATA_CONFIG">test/fixtures/library/libs/my-lib/data/src/data.module.ts</a>
            </td>
            <td>variable</td>
            <td>DATA_CONFIG</td>
            <td align="right" data-sort="0">
        ...
        <tr class="low">
            <td>
                <!-- miscellaneous -->
                        <a href="./miscellaneous/functions.html#getDefaultApiRoot">test/fixtures/library/libs/my-lib/data/src/utils.ts</a>
            </td>
            <td>function</td>
            <td>getDefaultApiRoot</td>
            <td align="right" data-sort="0">
