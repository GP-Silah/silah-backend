...
async function main() {
  ...
  const childCategories = [
    ...
    { name: 'Pet Accessories & Toys', parent: 'Agricultural & Pet Supplies' },
    ...
    { name: 'Dairy & Dairy Alternatives', parent: 'Food, Beverages & Health' },
    ...
    { name: 'Renewable Energy Products', parent: 'Energy & Sustainability' },

    { name: 'Business Consulting', parent: 'Business & Marketing Services' },
    {
    ...
    { name: 'Packaging & Co-Packaging', parent: 'Manufacturing & Packaging' },
    ...
    { name: 'Industrial Maintenance', parent: 'Technical & Repair Services' },
